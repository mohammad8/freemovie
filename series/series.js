...
async function getSeriesDetails() {
    try {
        ...
        document.getElementById('poster').src = (series.Poster && series.Poster !== "N/A") 
            ? series.Poster 
        ...
        if (series.Poster && series.Poster !== "N/A") {
            ...
            document.getElementById('series-bg').style.backgroundImage = `url('https://via.placeholder.com/1920x1080')`; // default bg
        }
...
// generate download links for all seasons
...
// generate download links for all qualities
