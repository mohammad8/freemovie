...
async function getFeaturedMovies() {
    try {
        ...
        movies.forEach((movie) => {
            ...
            const backdropPath = `https://freemoviez.ir/images/api/backdrop_${movie.backdrop_path.replace('/', '')}`;
...
async function getNewMovies() {
    try {
        ...
        movies.forEach((movie) => {
            // استفاده از URL تصاویر از سرور واسط
            const posterPath = `https://freemoviez.ir/images/api/poster_${movie.poster_path.replace('/', '')}`;
